...
exports.EXAMPLE_TEMPLATES = void 0;
exports.getExampleTemplateById = getExampleTemplateById;
exports.getExampleTemplatesByCategory = getExampleTemplatesByCategory;
exports.getExampleTemplatesByOccasion = getExampleTemplatesByOccasion;
...
function getExampleTemplateById(id) {
    return exports.EXAMPLE_TEMPLATES.find(template => template.id === id);
}
function getExampleTemplatesByCategory(category) {
    return exports.EXAMPLE_TEMPLATES.filter(template => template.category === category);
}
function getExampleTemplatesByOccasion(occasion) {
    return exports.EXAMPLE_TEMPLATES.filter(template => template.occasion === occasion);
}
