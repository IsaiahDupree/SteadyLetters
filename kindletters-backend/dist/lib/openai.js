...
exports.generateLetterContent = generateLetterContent;
...
async function generateLetterContent(params) {
...
exports.openai = {
    ...
    chat: {
        completions: {
            create: (params) => getOpenAI().chat.completions.create(params),
        },
    },
    audio: {
        transcriptions: {
            create: (params) => getOpenAI().audio.transcriptions.create(params),
        },
    },
    images: {
        generate: (params) => getOpenAI().images.generate(params),
    },
};
