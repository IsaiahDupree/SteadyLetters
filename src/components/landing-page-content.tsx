...
export function LandingPageContent() {
  ...
  // Track landing view on mount with UTM parameters
  useEffect(() => {
    const utm_source = searchParams.get('utm_source');
    const utm_medium = searchParams.get('utm_medium');
    const utm_campaign = searchParams.get('utm_campaign');

    tracking.trackLandingView({
  ...
  const handleCTAClick = (cta_text: string, cta_location: string, target_url: string) => {
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="text-lg px-8 h-14 bg-gradient-to-r from-primary to-violet-600 hover:from-primary/90 hover:to-violet-600/90 shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all hover:scale-105"
              onClick={() => handleCTAClick('Start Free Trial', 'hero', '/generate')}
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="text-lg px-8 h-14 hover:bg-muted/50 transition-all hover:scale-105"
              onClick={() => handleCTAClick('View Pricing', 'hero', '/pricing')}
            >
      ...
      <section className="bg-gradient-to-r from-primary to-purple-600 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            ...
            onClick={() => handleCTAClick('Get Started Free', 'bottom-cta', '/generate')}
          >
